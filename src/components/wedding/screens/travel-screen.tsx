...
export function TravelScreen({ setActiveTab }: { setActiveTab: (tab: AppTab) => void }) {
  return (
    <div className="animate-fade-in animate-slide-right pb-10">
      ...
      <div className="mt-8 space-y-6 px-6">
        <div className="rounded-3xl border bg-white/60 p-6 shadow-sm" style={{ borderColor: theme.border }}>
          <h4 className="mb-2 font-serif text-xl text-[#2a2723]">Accommodation Preferences</h4>
          <p className="mb-4 text-sm font-light leading-relaxed text-gray-600">
            Please take a moment to fill out your accommodation preferences below. Knowing where everyone is staying allows us to finalise our courtesy shuttle routes and designate convenient stops along the way.
          </p>
          <AccommodationForm />
        </div>

        <div className="relative overflow-hidden rounded-3xl border bg-white/60 p-6 shadow-sm" style={{ borderColor: theme.border }}>
          <div className="absolute right-4 top-4 rounded-md bg-[#2a2723] px-2.5 py-1 text-[9px] font-bold uppercase tracking-widest text-[#c3a379] shadow-md">
            Fully Booked
          </div>
          <h4 className="mb-2 pr-24 font-serif text-xl text-[#2a2723]">Staying On-Site</h4>
          <p className="mb-3 text-xs font-bold uppercase tracking-widest text-[#c3a379]">Spicers Clovelly Estate</p>
          <p className="mb-4 border-l-2 pl-3 text-sm font-light italic leading-relaxed text-gray-600" style={{ borderColor: theme.gold }}>
          ...
          <p className="mb-3 text-sm font-light leading-relaxed text-gray-600">
            If you are joining Jamie and J-rod on-site for Friday night, you are invited to a welcome meet-and-greet followed by a BBQ overlooking the lake.
          </p>
          <p className="text-sm font-light leading-relaxed text-gray-600">
            On Saturday, Friday night guests will have the option of breakfast in the restaurant or via room service, and a BBQ lunch will be provided before the festivities begin.
          </p>
        </div>

        <div className="rounded-3xl border bg-white/60 p-6 shadow-sm" style={{ borderColor: theme.border }}>
          <h4 className="mb-2 font-serif text-xl text-[#2a2723]">Staying Off-Site</h4>
          <p className="mb-4 text-xs font-bold uppercase tracking-widest text-[#c3a379]">Montville Area</p>
          <p className="mb-4 text-sm font-light leading-relaxed text-gray-600">
            Special rates are available for our guests via the Expedia links below:
          </p>
          <div className="mb-6 space-y-3">
            {[
              { href: "https://expedia.com/affiliates/jarod_and_jamies_wedding2n/2nights", title: "Book 2 Nights", sub: "Check-in 25th, Check-out 27th" },
              { href: "https://expedia.com/affiliates/jarod_and_jamies_wedding2n/1night", title: "Book 1 Night", sub: "Night of the wedding (26th)" },
            ].map((link) => (
              <a
                key={link.href}
                href={link.href}
              ...
              >
                <div>
                  ...
                  <p className="mt-0.5 text-[10px] uppercase tracking-wider text-gray-500">{link.sub}</p>
                </div>
          ...
          <div className="mb-6 rounded-2xl border border-rose-100 bg-rose-50/80 p-4 text-center text-[10px] font-bold uppercase leading-relaxed tracking-wider text-rose-800 shadow-sm">
            <span className="mb-2 inline-block rounded-md bg-rose-200 px-2 py-1 text-rose-900">Please Note</span>
            <br />
        ...
        <div className="rounded-3xl border bg-white/60 p-6 shadow-sm" style={{ borderColor: theme.border }}>
          <h4 className="mb-2 font-serif text-xl text-[#2a2723]">Driving & Parking</h4>
          <p className="mb-3 text-sm font-light leading-relaxed text-gray-600">
        ...
        <div className="rounded-3xl border bg-white/60 p-6 shadow-sm" style={{ borderColor: theme.border }}>
          <div className="mb-4 flex items-center gap-2">
            ...
            <h4 className="font-serif text-xl text-[#2a2723]">Flights + Getting to the Venue</h4>
          </div>
          <p className="mb-4 text-sm font-light leading-relaxed text-gray-600">
            Tap a section below for airport options, travel costs, and how to get to Spicers
            Clovelly Estate.
          </p>
